...
func (q transcodeQuery) One() (*Transcode, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for transcode")
	}
...
func (q transcodeQuery) All() (TranscodeSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to Transcode slice")
	}
...
func (q transcodeQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count transcode rows")
	}
...
func (q transcodeQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if transcode exists")
	}
...
func FindTranscode(exec boil.Executor, asset int, selectCols ...string) (*Transcode, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from transcode")
	}
...
func (o *Transcode) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no transcode provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into transcode")
	}
...
func (o *Transcode) Update(exec boil.Executor, whitelist ...string) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update transcode row")
	}
...
func (q transcodeQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for transcode")
	}
...
func (o *Transcode) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no transcode provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert transcode, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert transcode")
	}
...
func (o *Transcode) DeleteG() error {
	if o == nil {
		return errors.New("models: no Transcode provided for deletion")
	}
...
func (o *Transcode) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no Transcode provided for delete")
	}
...
func (q transcodeQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no transcodeQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from transcode")
	}
...
func (o TranscodeSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no Transcode slice provided for delete all")
	}
...
func (o *Transcode) ReloadG() error {
	if o == nil {
		return errors.New("models: no Transcode provided for reload")
	}
...
func (o *TranscodeSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty TranscodeSlice provided for reload all")
	}
...
func (o *TranscodeSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in TranscodeSlice")
	}
...
func TranscodeExists(exec boil.Executor, asset int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if transcode exists")
	}
