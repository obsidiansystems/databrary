...
func (q recordMeasureQuery) One() (*RecordMeasure, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for record_measures")
	}
...
func (q recordMeasureQuery) All() (RecordMeasureSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to RecordMeasure slice")
	}
...
func (q recordMeasureQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count record_measures rows")
	}
...
func (q recordMeasureQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if record_measures exists")
	}
...
func FindRecordMeasure(exec boil.Executor, id int, selectCols ...string) (*RecordMeasure, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from record_measures")
	}
...
func (o *RecordMeasure) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no record_measures provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into record_measures")
	}
...
func (o *RecordMeasure) Update(exec boil.Executor, whitelist ...string) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update record_measures row")
	}
...
func (q recordMeasureQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for record_measures")
	}
...
func (o *RecordMeasure) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no record_measures provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert record_measures, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert record_measures")
	}
...
func (o *RecordMeasure) DeleteG() error {
	if o == nil {
		return errors.New("models: no RecordMeasure provided for deletion")
	}
...
func (o *RecordMeasure) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no RecordMeasure provided for delete")
	}
...
func (q recordMeasureQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no recordMeasureQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from record_measures")
	}
...
func (o RecordMeasureSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no RecordMeasure slice provided for delete all")
	}
...
func (o *RecordMeasure) ReloadG() error {
	if o == nil {
		return errors.New("models: no RecordMeasure provided for reload")
	}
...
func (o *RecordMeasureSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty RecordMeasureSlice provided for reload all")
	}
...
func (o *RecordMeasureSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in RecordMeasureSlice")
	}
...
func RecordMeasureExists(exec boil.Executor, id int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if record_measures exists")
	}
