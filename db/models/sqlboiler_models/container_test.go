...
func testContainerToManySlotReleases(t *testing.T) {
	...
	randomize.Struct(seed, &b, slotReleaseDBTypes, false, slotReleaseColumnsWithDefault...)
	randomize.Struct(seed, &c, slotReleaseDBTypes, false, slotReleaseColumnsWithDefault...)
...
func testContainerToManySlotAssets(t *testing.T) {
	...
	randomize.Struct(seed, &b, slotAssetDBTypes, false, slotAssetColumnsWithDefault...)
	randomize.Struct(seed, &c, slotAssetDBTypes, false, slotAssetColumnsWithDefault...)
...
func testContainerToManyAddOpSlotReleases(t *testing.T) {
	...
	for _, x := range foreigners {
		if err = randomize.Struct(seed, x, slotReleaseDBTypes, false, strmangle.SetComplement(slotReleasePrimaryKeyColumns, slotReleaseColumnsWithoutDefault)...); err != nil {
			t.Fatal(err)
		}
	}
...
func testContainerToManyAddOpSlotAssets(t *testing.T) {
	...
	for _, x := range foreigners {
		if err = randomize.Struct(seed, x, slotAssetDBTypes, false, strmangle.SetComplement(slotAssetPrimaryKeyColumns, slotAssetColumnsWithoutDefault)...); err != nil {
			t.Fatal(err)
		}
	}
