...
func (o *Notice) Update(exec boil.Executor, whitelist ...string) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update notice row")
	}
...
func (q noticeQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for notice")
	}
...
func (o NoticeSlice) UpdateAll(exec boil.Executor, cols M) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update all in notice slice")
	}
...
func (o *Notice) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert notice")
	}
...
func (o *Notice) DeleteG() error {
	if o == nil {
		return errors.New("models: no Notice provided for deletion")
	}
...
func (o *Notice) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no Notice provided for delete")
	}
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from notice")
	}
...
func (q noticeQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no noticeQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from notice")
	}
...
func (o NoticeSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no Notice slice provided for delete all")
	}
...
func (o NoticeSlice) DeleteAll(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from notice slice")
	}
...
func NoticeExists(exec boil.Executor, id int16) (bool, error) {
	...
	sql := "select exists(select 1 from \"notice\" where \"id\"=$1 limit 1)"
