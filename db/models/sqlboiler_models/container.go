...
func FindContainer(exec boil.Executor, id int, selectCols ...string) (*Container, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from container")
	}
...
func (o *Container) Update(exec boil.Executor, whitelist ...string) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update container row")
	}
...
func (q containerQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for container")
	}
...
func (o *Container) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no container provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert container, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert container")
	}
...
func (q containerQuery) DeleteAll() error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from container")
	}
...
func ContainerExists(exec boil.Executor, id int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if container exists")
	}
