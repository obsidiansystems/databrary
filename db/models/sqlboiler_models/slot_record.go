...
func FindSlotRecord(exec boil.Executor, container int, segment custom_types.Segment, record int, selectCols ...string) (*SlotRecord, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from slot_record")
	}
...
func (o *SlotRecord) Update(exec boil.Executor, whitelist ...string) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update slot_record row")
	}
...
func (q slotRecordQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for slot_record")
	}
...
func (o *SlotRecord) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no slot_record provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert slot_record, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert slot_record")
	}
...
func (o *SlotRecord) DeleteG() error {
	if o == nil {
		return errors.New("models: no SlotRecord provided for deletion")
	}
...
func (o *SlotRecord) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no SlotRecord provided for delete")
	}
...
func (q slotRecordQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no slotRecordQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from slot_record")
	}
...
func (o SlotRecordSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no SlotRecord slice provided for delete all")
	}
...
func (o *SlotRecord) ReloadG() error {
	if o == nil {
		return errors.New("models: no SlotRecord provided for reload")
	}
...
func (o *SlotRecordSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty SlotRecordSlice provided for reload all")
	}
...
func (o *SlotRecordSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in SlotRecordSlice")
	}
...
func SlotRecordExists(exec boil.Executor, container int, segment custom_types.Segment, record int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if slot_record exists")
	}
