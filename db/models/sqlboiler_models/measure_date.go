...
func FindMeasureDate(exec boil.Executor, record int, metric int, selectCols ...string) (*MeasureDate, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from measure_date")
	}
...
func (o *MeasureDate) Update(exec boil.Executor, whitelist ...string) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update measure_date row")
	}
...
func (q measureDateQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for measure_date")
	}
...
func (o *MeasureDate) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no measure_date provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert measure_date, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert measure_date")
	}
...
func (o *MeasureDate) DeleteG() error {
	if o == nil {
		return errors.New("models: no MeasureDate provided for deletion")
	}
...
func (o *MeasureDate) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no MeasureDate provided for delete")
	}
...
func (q measureDateQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no measureDateQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from measure_date")
	}
...
func (o MeasureDateSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no MeasureDate slice provided for delete all")
	}
...
func (o *MeasureDate) ReloadG() error {
	if o == nil {
		return errors.New("models: no MeasureDate provided for reload")
	}
...
func (o *MeasureDateSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty MeasureDateSlice provided for reload all")
	}
...
func (o *MeasureDateSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in MeasureDateSlice")
	}
...
func MeasureDateExists(exec boil.Executor, record int, metric int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if measure_date exists")
	}
