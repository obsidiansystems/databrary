...
var (
	uploadColumns               = []string{"token", "expires", "account", "volume", "filename", "size"}
	uploadColumnsWithoutDefault = []string{"token", "account", "volume", "filename", "size"}
	uploadColumnsWithDefault    = []string{"expires"}
	uploadColumnsWithCustom     = []string{}

	uploadPrimaryKeyColumns = []string{"token"}
)
...
// OneP returns a single upload record from the query, and panics on error.
func (q uploadQuery) OneP() *Upload {
	o, err := q.One()
	if err != nil {
...
func (q uploadQuery) One() (*Upload, error) {
	o := &Upload{}
...
// AllP returns all Upload records from the query, and panics on error.
func (q uploadQuery) AllP() UploadSlice {
	o, err := q.All()
	if err != nil {
		panic(boil.WrapErr(err))
	}
...
func (q uploadQuery) All() (UploadSlice, error) {
	var o UploadSlice
...
// CountP returns the count of all Upload records in the query, and panics on error.
func (q uploadQuery) CountP() int64 {
	c, err := q.Count()
	if err != nil {
		panic(boil.WrapErr(err))
	}
...
func (q uploadQuery) Count() (int64, error) {
	var count int64
...
func (q uploadQuery) ExistsP() bool {
	e, err := q.Exists()
	if err != nil {
		panic(boil.WrapErr(err))
	}
...
func (q uploadQuery) Exists() (bool, error) {
	var count int64
...
func (o *Upload) AccountByFk(exec boil.Executor, mods ...qm.QueryMod) accountQuery {
...
func (uploadL) LoadAccount(e boil.Executor, singular bool, maybeUpload interface{}) error {
	var slice []*Upload
	var object *Upload
...
// SetAccountG of the upload to the related item.
// Sets o.R.Account to related.
// Adds o to related.R.Uploads.
// Uses the global database handle.
func (o *Upload) SetAccountG(insert bool, related *Account) error {
	return o.SetAccount(boil.GetDB(), insert, related)
}

// SetAccountP of the upload to the related item.
// Sets o.R.Account to related.
// Adds o to related.R.Uploads.
// Panics on error.
func (o *Upload) SetAccountP(exec boil.Executor, insert bool, related *Account) {
	if err := o.SetAccount(exec, insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetAccountGP of the upload to the related item.
// Sets o.R.Account to related.
// Adds o to related.R.Uploads.
// Uses the global database handle and panics on error.
func (o *Upload) SetAccountGP(insert bool, related *Account) {
	if err := o.SetAccount(boil.GetDB(), insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetAccount of the upload to the related item.
// Sets o.R.Account to related.
// Adds o to related.R.Uploads.
func (o *Upload) SetAccount(exec boil.Executor, insert bool, related *Account) error {
	var err error
	if insert {
...
// UploadsG retrieves all records.
func UploadsG(mods ...qm.QueryMod) uploadQuery {
	return Uploads(boil.GetDB(), mods...)
}

// Uploads retrieves all the records using an executor.
func Uploads(exec boil.Executor, mods ...qm.QueryMod) uploadQuery {
	mods = append(mods, qm.From("\"upload\""))
	return uploadQuery{NewQuery(exec, mods...)}
}

// FindUploadG retrieves a single record by ID.
func FindUploadG(token string, selectCols ...string) (*Upload, error) {
	return FindUpload(boil.GetDB(), token, selectCols...)
}

// FindUploadGP retrieves a single record by ID, and panics on error.
func FindUploadGP(token string, selectCols ...string) *Upload {
	retobj, err := FindUpload(boil.GetDB(), token, selectCols...)
	if err != nil {
		panic(boil.WrapErr(err))
	}
...
func FindUpload(exec boil.Executor, token string, selectCols ...string) (*Upload, error) {
	uploadObj := &Upload{}
	...
	query := fmt.Sprintf(
		"select %s from \"upload\" where \"token\"=$1", sel,
	)

	q := queries.Raw(exec, query, token)

	err := q.Bind(uploadObj)
	if err != nil {
		if errors.Cause(err) == sql.ErrNoRows {
			return nil, sql.ErrNoRows
		}
...
// FindUploadP retrieves a single record by ID with an executor, and panics on error.
func FindUploadP(exec boil.Executor, token string, selectCols ...string) *Upload {
	retobj, err := FindUpload(exec, token, selectCols...)
	if err != nil {
		panic(boil.WrapErr(err))
	}
...
func (o *Upload) InsertG(whitelist ...string) error {
	return o.Insert(boil.GetDB(), whitelist...)
}

// InsertGP a single record, and panics on error. See Insert for whitelist
// behavior description.
func (o *Upload) InsertGP(whitelist ...string) {
...
func (o *Upload) InsertP(exec boil.Executor, whitelist ...string) {
...
func (o *Upload) Insert(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"upload\" (\"%s\") VALUES (%s)", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.IndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"upload\" DEFAULT VALUES"
		}
...
// UpdateG a single Upload record. See Update for
// whitelist behavior description.
func (o *Upload) UpdateG(whitelist ...string) error {
	return o.Update(boil.GetDB(), whitelist...)
}

// UpdateGP a single Upload record.
// UpdateGP takes a whitelist of column names that should be updated.
// Panics on error. See Update for whitelist behavior description.
func (o *Upload) UpdateGP(whitelist ...string) {
	if err := o.Update(boil.GetDB(), whitelist...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// UpdateP uses an executor to update the Upload, and panics on error.
// See Update for whitelist behavior description.
func (o *Upload) UpdateP(exec boil.Executor, whitelist ...string) {
...
func (o *Upload) Update(exec boil.Executor, whitelist ...string) error {
	var err error
...
func (q uploadQuery) UpdateAllP(cols M) {
...
func (q uploadQuery) UpdateAll(cols M) error {
...
func (o UploadSlice) UpdateAllG(cols M) error {
	return o.UpdateAll(boil.GetDB(), cols)
}

// UpdateAllGP updates all rows with the specified column values, and panics on error.
func (o UploadSlice) UpdateAllGP(cols M) {
...
func (o UploadSlice) UpdateAllP(exec boil.Executor, cols M) {
...
func (o UploadSlice) UpdateAll(exec boil.Executor, cols M) error {
	ln := int64(len(o))
	if ln == 0 {
		return nil
	}
...
func (o *Upload) UpsertG(updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	return o.Upsert(boil.GetDB(), updateOnConflict, conflictColumns, updateColumns, whitelist...)
}

// UpsertGP attempts an insert, and does an update or ignore on conflict. Panics on error.
func (o *Upload) UpsertGP(updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) {
...
func (o *Upload) UpsertP(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) {
...
func (o *Upload) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	...
	if !cached {
		...
		cache.query = queries.BuildUpsertQueryPostgres(dialect, "\"upload\"", updateOnConflict, ret, update, conflict, whitelist)

		cache.valueMapping, err = queries.BindMapping(uploadType, uploadMapping, whitelist)
		if err != nil {
			return err
		}
		if len(ret) != 0 {
...
// DeleteP deletes a single Upload record with an executor.
// DeleteP will match against the primary key column to find the record to delete.
// Panics on error.
func (o *Upload) DeleteP(exec boil.Executor) {
...
// DeleteGP deletes a single Upload record.
// DeleteGP will match against the primary key column to find the record to delete.
// Panics on error.
func (o *Upload) DeleteGP() {
...
func (o UploadSlice) DeleteAllGP() {
...
func (o UploadSlice) DeleteAllP(exec boil.Executor) {
...
func (o *Upload) ReloadP(exec boil.Executor) {
...
func (o *Upload) Reload(exec boil.Executor) error {
	ret, err := FindUpload(exec, o.Token)
	if err != nil {
		return err
	}
...
// Panics on error.
func (o *UploadSlice) ReloadAllGP() {
...
// and overwrites the original object slice with the newly updated slice.
// Panics on error.
func (o *UploadSlice) ReloadAllP(exec boil.Executor) {
...
func UploadExistsG(token string) (bool, error) {
	return UploadExists(boil.GetDB(), token)
}

// UploadExistsGP checks if the Upload row exists. Panics on error.
func UploadExistsGP(token string) bool {
	e, err := UploadExists(boil.GetDB(), token)
	if err != nil {
		panic(boil.WrapErr(err))
	}
...
// UploadExistsP checks if the Upload row exists. Panics on error.
func UploadExistsP(exec boil.Executor, token string) bool {
	e, err := UploadExists(exec, token)
	if err != nil {
		panic(boil.WrapErr(err))
	}
