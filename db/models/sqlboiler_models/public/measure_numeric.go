...
func FindMeasureNumeric(exec boil.Executor, record int, metric int, selectCols ...string) (*MeasureNumeric, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from measure_numeric")
	}
...
func (o *MeasureNumeric) Update(exec boil.Executor, whitelist ...string) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update measure_numeric row")
	}
...
func (q measureNumericQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for measure_numeric")
	}
...
func (o *MeasureNumeric) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no measure_numeric provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert measure_numeric, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert measure_numeric")
	}
...
func (o *MeasureNumeric) DeleteG() error {
	if o == nil {
		return errors.New("models: no MeasureNumeric provided for deletion")
	}
...
func (o *MeasureNumeric) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no MeasureNumeric provided for delete")
	}
...
func (q measureNumericQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no measureNumericQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from measure_numeric")
	}
...
func (o MeasureNumericSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no MeasureNumeric slice provided for delete all")
	}
...
func (o *MeasureNumeric) ReloadG() error {
	if o == nil {
		return errors.New("models: no MeasureNumeric provided for reload")
	}
...
func (o *MeasureNumericSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty MeasureNumericSlice provided for reload all")
	}
...
func (o *MeasureNumericSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in MeasureNumericSlice")
	}
...
func MeasureNumericExists(exec boil.Executor, record int, metric int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if measure_numeric exists")
	}
