...
func (q notifyViewQuery) One() (*NotifyView, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for notify_view")
	}
...
func (q notifyViewQuery) All() (NotifyViewSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to NotifyView slice")
	}
...
func (q notifyViewQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count notify_view rows")
	}
...
func (q notifyViewQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if notify_view exists")
	}
...
func (o *NotifyView) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no notify_view provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into notify_view")
	}
