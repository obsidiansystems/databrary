...
func (q measureDateQuery) One() (*MeasureDate, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "audit: failed to execute a one query for measure_date")
	}
...
func (q measureDateQuery) All() (MeasureDateSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "audit: failed to assign all query results to MeasureDate slice")
	}
...
func (q measureDateQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "audit: failed to count measure_date rows")
	}
...
func (q measureDateQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "audit: failed to check if measure_date exists")
	}
...
func (o *MeasureDate) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("audit: no measure_date provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "audit: unable to insert into measure_date")
	}
