...
func (q volumeInclusionQuery) One() (*VolumeInclusion, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "audit: failed to execute a one query for volume_inclusion")
	}
...
func (q volumeInclusionQuery) All() (VolumeInclusionSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "audit: failed to assign all query results to VolumeInclusion slice")
	}
...
func (q volumeInclusionQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "audit: failed to count volume_inclusion rows")
	}
...
func (q volumeInclusionQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "audit: failed to check if volume_inclusion exists")
	}
...
func (o *VolumeInclusion) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("audit: no volume_inclusion provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "audit: unable to insert into volume_inclusion")
	}
