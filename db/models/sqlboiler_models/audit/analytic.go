...
func (q analyticQuery) One() (*Analytic, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "audit: failed to execute a one query for analytic")
	}
...
func (q analyticQuery) All() (AnalyticSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "audit: failed to assign all query results to Analytic slice")
	}
...
func (q analyticQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "audit: failed to count analytic rows")
	}
...
func (q analyticQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "audit: failed to check if analytic exists")
	}
...
func (o *Analytic) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("audit: no analytic provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "audit: unable to insert into analytic")
	}
