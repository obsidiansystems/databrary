...
var (
	avatarDBTypes = map[string]string{`Asset`: `integer`, `AuditAction`: `enum.action('attempt','open','close','add','change','remove','superuser')`, `AuditIP`: `inet`, `AuditTime`: `timestamp with time zone`, `AuditUser`: `integer`, `Party`: `integer`}
	_             = bytes.MinRead
)
