...
func (q slotAssetQuery) One() (*SlotAsset, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "audit: failed to execute a one query for slot_asset")
	}
...
func (q slotAssetQuery) All() (SlotAssetSlice, error) {
	...
	err := q.Bind(&o)
	if err != nil {
		return nil, errors.Wrap(err, "audit: failed to assign all query results to SlotAsset slice")
	}
...
func (q slotAssetQuery) Count() (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "audit: failed to count slot_asset rows")
	}
...
func (q slotAssetQuery) Exists() (bool, error) {
	...
	err := q.Query.QueryRow().Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "audit: failed to check if slot_asset exists")
	}
...
func (o *SlotAsset) Insert(exec boil.Executor, whitelist ...string) error {
	if o == nil {
		return errors.New("audit: no slot_asset provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "audit: unable to insert into slot_asset")
	}
