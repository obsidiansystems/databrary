...
var (
	...
	assetColumnsWithCustom     = []string{"release"}
...
func (o *Asset) Update(exec boil.Executor, whitelist ...string) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update asset row")
	}
...
func (q assetQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for asset")
	}
...
func (o *Asset) DeleteG() error {
	if o == nil {
		return errors.New("models: no Asset provided for deletion")
	}
...
func (o *Asset) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no Asset provided for delete")
	}
...
func (q assetQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no assetQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from asset")
	}
...
func (o AssetSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no Asset slice provided for delete all")
	}
