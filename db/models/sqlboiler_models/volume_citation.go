...
func FindVolumeCitation(exec boil.Executor, volume int, selectCols ...string) (*VolumeCitation, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from volume_citation")
	}
...
func (o *VolumeCitation) Update(exec boil.Executor, whitelist ...string) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update volume_citation row")
	}
...
func (q volumeCitationQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for volume_citation")
	}
...
func (o *VolumeCitation) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no volume_citation provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert volume_citation, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert volume_citation")
	}
...
func (o *VolumeCitation) DeleteG() error {
	if o == nil {
		return errors.New("models: no VolumeCitation provided for deletion")
	}
...
func (o *VolumeCitation) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no VolumeCitation provided for delete")
	}
...
func (q volumeCitationQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no volumeCitationQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from volume_citation")
	}
...
func (o VolumeCitationSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no VolumeCitation slice provided for delete all")
	}
...
func (o *VolumeCitation) ReloadG() error {
	if o == nil {
		return errors.New("models: no VolumeCitation provided for reload")
	}
...
func (o *VolumeCitationSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty VolumeCitationSlice provided for reload all")
	}
...
func (o *VolumeCitationSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in VolumeCitationSlice")
	}
...
func VolumeCitationExists(exec boil.Executor, volume int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if volume_citation exists")
	}
