...
func FindSlotAsset(exec boil.Executor, asset int, selectCols ...string) (*SlotAsset, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from slot_asset")
	}
...
func (o *SlotAsset) Update(exec boil.Executor, whitelist ...string) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update slot_asset row")
	}
...
func (q slotAssetQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for slot_asset")
	}
...
func (o *SlotAsset) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
		return errors.New("models: no slot_asset provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("models: unable to upsert slot_asset, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert slot_asset")
	}
...
func (o *SlotAsset) DeleteG() error {
	if o == nil {
		return errors.New("models: no SlotAsset provided for deletion")
	}
...
func (o *SlotAsset) Delete(exec boil.Executor) error {
	if o == nil {
		return errors.New("models: no SlotAsset provided for delete")
	}
...
func (q slotAssetQuery) DeleteAll() error {
	if q.Query == nil {
		return errors.New("models: no slotAssetQuery provided for delete all")
	}
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from slot_asset")
	}
...
func (o SlotAssetSlice) DeleteAllG() error {
	if o == nil {
		return errors.New("models: no SlotAsset slice provided for delete all")
	}
...
func (o *SlotAsset) ReloadG() error {
	if o == nil {
		return errors.New("models: no SlotAsset provided for reload")
	}
...
func (o *SlotAssetSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("models: empty SlotAssetSlice provided for reload all")
	}
...
func (o *SlotAssetSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in SlotAssetSlice")
	}
...
func SlotAssetExists(exec boil.Executor, asset int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if slot_asset exists")
	}
